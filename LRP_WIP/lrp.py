...
if __name__ == '__main__':
  ...
  #
  image_dir = "C:\\Users\\saqib\\OneDrive\\Desktop\\MSBA Fall\\Adv Pred Mod\\APM PROJECT\\test_images\\png_images\\"

  image_paths = [image_dir + image for image in os.listdir(image_dir)]
  # print(image_paths[0:2])

  image_names = [image.split('.')[0] for image in os.listdir(image_dir)]

  num_images = len(image_names)
  print(num_images)
  raw_images, processed_images = load_images(image_paths[:5])  # remove [:5] for all images
  print("Images loaded...")
